...
if __name__ == '__main__':
    ...
    filename = "Results_Ti64_Dream3D_ZdirLoad_210microns_9261el_AbqInp" +\
               "_PowerLaw_100inc_rotate_3_data_strain_inc%s.txt" % str(inc)
    ...
    filename = "Results_Ti64_Dream3D_ZdirLoad_210microns_9261el_AbqInp" +\
               "_PowerLaw_100inc_3_data_theta_inc%s.txt" % str(inc)

    np.savetxt(filename, theta, header=filename+"\ntheta")

    filename = "Results_Ti64_Dream3D_ZdirLoad_210microns_9261el_AbqInp" +\
               "_PowerLaw_100inc_3_data_en_inc%s.txt" % str(inc)

    np.savetxt(filename, en, header=filename+"\ntheta")
