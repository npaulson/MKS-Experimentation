...
epstest = Bmatrix(4.880218E-3, 1.563865E-4, -5.075973E-5, 0.5*(-6.266308E-5),
                  0.5*(6.025747E-5), 0.5*(6.866434E-4))
euler = np.array([[1.601652E2, 6.406010E1, 7.075200E0]])

print 'euler angles: %s' % euler
print '\nstarting strain tensor:'
print epstest
print '\nABAQUS stress value:'
print sigval
...
print '\nsig_sf from stiffness rotation:'
sig_sf = np.einsum('...kl,kl', Cijkl_, epstest)
print sig_sf
...
print '\nsig_sf from strain, stress rotations (tensor form)'
print sig_sf
...
print '\nsig_sf from strain, stress rotations (matrix form)'
print sig_sf
