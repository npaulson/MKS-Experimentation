...
def hist_extreme_val(el, ns, r_fem, r_mks, typ, comp, spr, plotnum):
    ...
    print bw_silverman
    kde = KernelDensity(kernel='gaussian', bandwidth=bw_silverman).fit(mks[:, np.newaxis])
...
def hist_extreme_val_2axis(el, ns, r_fem, r_mks, typ, comp, spr, plotnum):
    ...
    """
    In this version of the code I discovered that silverman's analytical
    approach to finding the proper bandwith for a univariate distribution
    is more effective than using scikit learn's GridSearchCV method
    """
...
if __name__ == '__main__':
    results(21, 398, 'val', 5, 4, 'epsilon', '12', 'p_b')
