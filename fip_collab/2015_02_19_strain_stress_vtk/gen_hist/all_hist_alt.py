...
def make_hist(el, ns_list, set_id_list, step, comp, typ):
    ...
    resp1L, = plt.plot(bincenters, n/(ns_list[0]*el**3), 'k', linestyle='-', lw=0.75)
    ...
    n, bins, patches = plt.hist(resp2L,
                                ...
                                range=(dmin, dmax),
                                color='white')
    resp2L, = plt.plot(bincenters, n/(ns_list[1]*el**3), 'b', linestyle='-', lw=0.75)
    ...
    n, bins, patches = plt.hist(resp3L,
                                ...
                                range=(dmin, dmax),
                                color='white')
    resp3L, = plt.plot(bincenters, n/(ns_list[2]*el**3), 'r', linestyle='-', lw=0.75)
    plt.grid(True)
    ...
    n, bins, patches = plt.hist(resp4L,
                                ...
                                range=(dmin, dmax),
                                color='white')
    resp4L, = plt.plot(bincenters, n/(ns_list[3]*el**3), 'g', linestyle='-', lw=0.75)
