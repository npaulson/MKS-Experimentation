...
set_id_cal = 'cal050'  # set ID for calibration dataset
dir_cal = 'cal050'  # directory name for .dat files
...
set_id_val = 'val050'  # set ID for validation dataset
dir_val = 'val050'  # directory name for .dat files
