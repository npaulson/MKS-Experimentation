...
"""Gather data from vtk files for polycrystals"""
...
"""Gather data from hdf5 file for single crystals"""
ge.read(strt_cal[-1], ns_cal[-1], set_id_cal[-1])
ge.read(strt_val[-1], ns_val[-1], set_id_val[-1])
