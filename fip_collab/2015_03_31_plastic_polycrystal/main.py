...
for step in xrange(1, 2):
    ...
    base.create_group("/", 'epsilon', 'total strain')
    ...
    base.create_group("/", 'epsilon', 'FFT of total strain')
    ...
    results_pl.results_all(el, ns_val, set_id_val, step, 'epsilon_p', compl,
                           comp_app)
