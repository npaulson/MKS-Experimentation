C((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))) HAMAD: Taylor code for FCC..Checked (from line 1 to 13)
	...
	RETURN
	END
C(((((((((((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))))) HAMAD: Checked (from line 14 to 42)
...
C********************************************************************* HAMAD: Checked (from line 42 to 176)
...
C**************************************************************  HAMAD: Checked (from line 179 to 198)
...
C  RECIPES.
C************************************************************* HAMAD: Checked (from line 205 to 226)
	...
	ENDIF
C
C  REFORMULATE THE EQUATION IN TERMS OF (E-1) AS UNKNOWN
C
	A1=-(3.0-IC)
 	A2=-(3.0-2.0*IC+IIC)
	A3=-(1.0-IC+IIC-IIIC)
...
C****************************************************************** HAMAD: Checked (from line 230 to 254)
...
C******************************************************************* HAMAD: Checked (from line 257 to 265)
	...
	RETURN
	END
C((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))))))))))	HAMAD: Checked (from line 266 to 422)
...
c       write(*,*) FTTAU(1,1), FTTAU(2,2), FTTAU(3,3)
	ELSE IF(LFLAG.EQ.4)THEN
          FTTAU(2,2) = DEXP(-(1-QFAC)*EDOT*TAU)
          FTTAU(1,1) = DEXP(-QFAC*EDOT*TAU)
          FTTAU(3,3) = DEXP(EDOT*TAU)
...
C	BELOW BY HAMAD: SIMPLE SHEAR WITH SUPERPOSED ROTATION
	ELSE IF(LFLAG.EQ.88)THEN
	PHIDOT=(2*PI)/100
		FTTAU(1,1) = COS(PHIDOT*TAU) 
		FTTAU(1,2) = EDOT*TAU*COS(PHIDOT*TAU)+SIN(PHIDOT*TAU)
		FTTAU(1,3) = 0
		FTTAU(2,1) = -SIN(PHIDOT*TAU)
		FTTAU(2,2) = -EDOT*TAU*SIN(PHIDOT*TAU)+COS(PHIDOT*TAU)
		FTTAU(2,3) = 0
		FTTAU(3,1) = 0
		FTTAU(3,2) = 0
		FTTAU(3,3) = 1
...
C
	...
	RETURN
	END	  
C(((((((((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))HAMAD: Checked (from line  422 to line 508)
...
C
 ...
 20	IF(ICHK.NE.1)THEN
	...
	END
C(((((((((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))
C(((((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))))))) HAMAD: Checked (from line 508 to line 594)
	SUBROUTINE FORMSP(ICRYS)
cvd$r  noconcur
	INCLUDE 'commonsn.tex'
	DIMENSION TMP(3,3)
C
C      DO 10 I = 1,12			HAMAD: This is for FCC and below for BCC, change 12 to 48
...
C
  10    CONTINUE
	RETURN
	END
C((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))))))))))) HAMAD: Checked (from line 593 to 824)
	SUBROUTINE INITIALIZE(IC)
	INCLUDE 'commonsn.tex'
	CHARACTER*60 DUMMY
	OPEN(UNIT=2,FILE='euler.inp',STATUS ='OLD')
	OPEN(UNIT=3,FILE='fcc12',STATUS = 'OLD')
C
...
c	write(111,*)((QMAT(J,K,icrys),K=1,3),J=1,3)
c	stop !sarah
C
...
cvd$         noconcur
C	     DO 70 J = 1,12		HAMAD: This is for FCC and below for BCC, change 12 to 48
		DO 70 J = 1,12
                ACCGAM(J,ICRYS) = 0.0
 70             CRSS(J,ICRYS) = SO
           ENDIF
...
C          READ(16,*)((CRSS(I,ICRYS),I=1,12),ICRYS=1,NCRYS)		HAMAD: This is for FCC and below for BCC, change 12 to 48
		READ(16,*)((CRSS(I,ICRYS),I=1,12),ICRYS=1,NCRYS)
         ENDIF
C
C  INITIALISE LATENT HARDENING MATRIX QLAT
C
C	DO 150 J = 1,12,	HAMAD: This is for FCC and below for BCC, change 12 to 48............ 
	DO 150 J = 1,12
C         DO 150 I = 1,12		HAMAD: This is for FCC and below for BCC, change 12 to 48
	   DO 150 I = 1,12
 150         QLAT(I,J) = QL
	DO 200 NBL = 1,4
     	   DO 200 JIND = 1,3
...
C
	...
	WRITE(10,101)DUMMY
	WRITE(11,101)DUMMY
c	WRITE(12,101)DUMMY
c	WRITE(13,101)DUMMY
c	WRITE(14,101)DUMMY
101     FORMAT(A6)
	DUMMY = 'S11'
	WRITE(10,101)DUMMY
	DUMMY ='S22'
...
c	WRITE(14,101)DUMMY
	...
	WRITE(10,110)DUMMY
	WRITE(11,110)DUMMY
c	WRITE(12,110)DUMMY
c	WRITE(13,110)DUMMY
c	WRITE(14,110)DUMMY
110	FORMAT(A9)
	DUMMY = 'END'
	WRITE(10,120)DUMMY
	WRITE(11,120)DUMMY
c	WRITE(12,120)DUMMY
c	WRITE(13,120)DUMMY
c	WRITE(14,120)DUMMY
120	FORMAT(A3)
	DUMMY = '0.0 0.0'
        IF(IC.EQ.0)THEN
	WRITE(10,110)DUMMY
...
c	WRITE(14,110)DUMMY
	...
	RETURN
	END
C(((((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))))))))) HAMAD: Checked (from line 824 to line 846)
        SUBROUTINE INPUT
        INCLUDE 'commonsn.tex'
C	CHARACTER DUMMY
C	DIMENSION DUMMY(80)
C
	OPEN(UNIT=1,FILE='temptay.inp',STATUS='OLD')
        READ(1,1)DUMMY
1       FORMAT(80A1)
	...
	RETURN
	END	
C************************************************************************** HAMAD: Checked (from line 842 to line HAMAD)
...
C
        INCLUDE 'commonsn.tex'
C
	OPEN(UNIT=10,FILE='s11',STATUS='REPLACE')
	OPEN(UNIT=11,FILE='s22',STATUS='REPLACE')
	OPEN(UNIT=12,FILE='s12',STATUS='REPLACE')
	OPEN(UNIT=13,FILE='s33',STATUS='REPLACE')
	OPEN(UNIT=14,FILE='s13',STATUS='REPLACE')
	OPEN(UNIT=17,FILE='crystalstresses.txt',STATUS='REPLACE')
	OPEN(UNIT=8,FILE='texture.out',STATUS='REPLACE')
	OPEN(UNIT=9,FILE='errorfile')
      OPEN(UNIT=15,FILE='ept.res')
      OPEN(UNIT=16,FILE='ept.res0',STATUS='OLD')
	open(unit=21,file='wstar.txt',STATUS='REPLACE')
	open(unit=111,file='Hamad_test.txt',STATUS='REPLACE')
...
c	LOOP FOR THETA, Hamad: To include all deformation mode, select FTHETA = 30 for Plain Strain Compression 
C      do 1234 ITHETA=1,120 
c	do 1234 ITHETA=1,360
c	I changed 80 to 1 to have only one theta
	

C	WRITE(*,*)ITHETA 
c	FTHETA = 0.523598776
c	FTHETA=(ITHETA-1)*2*PI/80
		
c		FTHETA = (PI/180)*122
 
C	FTHETA = (ITHETA-1)*2*PI/120
C	deformation mode									Hamad: For plain Strain compression
	FTHETA = (PI/180)*70.98

C	Theta_Flag=1.0
c	write (*,*)'Enter 1 if you want to use Theta in Ftau instead of q'
c	write (*,*)'NOTE: LFLAG in tempay.inp has to be 3 to use theta'
c	read (*,*) Theta_Flag
	Theta_Flag=5555

	if (Theta_Flag .EQ. 1) then
	write(*,*) ' Theta is used in F(tau) instead of q'
	write(*,*) 'And the value of theta is', FTHETA*180/PI
	endif
...
C												
	...
	if (Theta_Flag .NE. 1) then
	write(*,*) ' Theta is NOT used in F(tau)'
	write(*,*) 'And LFLAG here is', LFLAG
	write(*,*) 'And QFLAG here is', QFAC
	endif
...
c	Hamad just for check
c	WRITE(*,*) ((TTAU(I,J,ICRYS),J=1,3),I=1,3)
c		WRITE(*,*) hid
c		WRITE(*,*)TTAU(1,1,ICRYS)-hid,
c     &      TTAU(2,2,ICRYS)-hid,
c     &   TTAU(1,2,ICRYS),TTAU(1,3,ICRYS),TTAU(2,3,ICRYS),TOTALGAM/DTIME

c	WRITE(17,888)TTAU(1,1,ICRYS)-hid,
c     &      TTAU(2,2,ICRYS)-hid,
c     &   TTAU(1,2,ICRYS),TTAU(1,3,ICRYS),TTAU(2,3,ICRYS),TOTALGAM/DTIME,
c     &	TTAU(3,3,ICRYS)-TTAU(1,1,ICRYS),
c     &    TTAU(3,3,ICRYS)-hid-(TTAU(1,1,ICRYS)-hid)

c	write(*,*)  TTAU(1,1,ICRYS), TTAU(2,2,ICRYS), TTAU(3,3,ICRYS)
c	write(*,*)  TTAU(1,1,ICRYS)-hid, TTAU(2,2,ICRYS)-hid,
c     & TTAU(3,3,ICRYS)-hid
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc

c            WRITE(17,98)TOTALGAM/DTIME                 
c format(9f15.11,I5)
c format(6f15.7)
          ENDIF
98        FORMAT(3F10.4)
...
c	TOTALGAM = 0.0
c	DO 933 J=1,12
c933   TOTALGAM = DABS(DGTAU(J,ICRYS))+TOTALGAM
c	write(*,*) DTIME,TTIME,Tau,TOTALGAM/DTIME


888   format(7f15.9)
c 98        FORMAT(6E15.9,E15.4) ovako je bilo
          DO 210 K = 1,3
              DO 210 J = 1,3
...
300	DO 301 K=1,NCRYS
	TACCGAM=0.
C	do 302 J=1,12				HAMAD: This is for FCC and below for BCC, change 12 to 48
	do 302 J=1,12		
...
C1234	CONTINUE       
	...
	STOP
	END
C((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))))))) HAMAD: Checked (from line 842 to line 1353) Not fully understood
c ------------ take out keyword recursive to run it on sun!!!!---
C
	SUBROUTINE NEWT(ICRYS)
cvd$r   noconcur											HAMAD: dimension below change from 12 to 48
	INCLUDE 'commonsn.tex'
	DIMENSION CRSSALPHA(12),CONST(6,6,12), DEPI(12),					
     &           ERR(6),AJAC(6,6),ABSA(6),D(6),UX(6),INDX(6),DTBV(6),
     &           ABDTBV(6),TRV(6),TBV(6),RSSTAU(12),ABSDG(12),
     &           CRSSNEW(12),HJ(12),TOLD(6)
       LOGICAL LMASK(6)
C
        ITER = 1
        DGDO = GDO*DTIME
...
C
        ...
        DMAX = 0.05D0
C
C        DO 1 I = 1,12				HAMAD: This is for FCC and below for BCC, change 12 to 48
	   DO 1 I = 1,12
...
C
	DO 20 J = 1,6
C        DO 20 I = 1,12		HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 20 I = 1,12
...
C
C	DO 30 I = 1,12			HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 30 I = 1,12
...
C
C      DO 50 I=1,12    HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 50 I=1,12		
           DO 50 J=1,6
...
C
           ENDIF
C        IF(I.LT.12) GO TO 99           HAMAD: This is for FCC and below for BCC, change 12 to 48
	  IF(I.LT.12) GO TO 99 
C
C==================================================================
...
C
	IF(ITER.GT.100)THEN
	  ...
	  WRITE(9,*)(TBV(I),I=1,6)
C         WRITE(9,*)(CRSSALPHA(I),I=1,12)			HAMAD: This is for FCC and below for BCC, change 12 to 48
	   WRITE(9,*)(CRSSALPHA(I),I=1,12)
	ENDIF
C
        IF(ITER.GT.110)STOP
998     CONTINUE
...
C       Evaluate resolved shear stress (ex-sbr RESOLVE)-------------
C
C	DO 310 I = 1,12							HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 310 I = 1,12
 310	 RSSTAU(I) = ZERO
C
	DO 320 J = 1,6
C         DO 320 I = 1,12					HAMAD: This is for FCC and below for BCC, change 12 to 48
		DO 320 I = 1,12
...
C
        AMAXDG = 0.0D0
C	DO 330 I = 1,12					HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 330 I = 1,12
	 IF(RSSTAU(I).EQ.ZERO)THEN
           ABSDG(I) = ZERO
           DGTAU(I,ICRYS) = ZERO
...
C
C	DO 350 I = 1,12				HAMAD: This is for FCC and below for BCC, change 12 to 48	
	DO 350 I = 1,12
C
...
C
 350   CONTINUE
C
C	DO 360 II = 1,12				HAMAD: This is for FCC and below for BCC, change 12 to 48
C	 DO 360 I = 1,12				HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 360 II = 1,12
	 DO 360 I = 1,12
 360       CRSSNEW(I) = CRSSNEW(I)+HJ(II)*QLAT(I,II)*ABSDG(II)
C
	ERCRSS = ZERO
C	DO 370 I = 1,12					HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 370 I = 1,12
...
C
        ...
        NSYS(ICRYS) = 0
C
C	DO 500 I = 1,12			HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 500 I = 1,12
...
C(((((((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))) HAMAD: Checked (from line 1353 to line 1390)
	SUBROUTINE OUTPUT
	INCLUDE 'commonsn.tex'
	write(111,888)AVGSTR(1,1),AVGSTR(2,2),AVGSTR(3,3),
     &		     AVGSTR(1,2),AVGSTR(1,3),AVGSTR(2,3),FTAU(1,2),tau
888   format(8f15.9)
	IF(LFLAG.EQ.1)THEN
	...
	IF(LFLAG.EQ.3.OR.LFLAG.EQ.4)THEN
 	   DDLFT = DABS(DLOG(FTAU(3,3)))
	   WRITE(10,95)DDLFT,AVGSTR(1,1), AVGSTR(2,2), AVGSTR(3,3),
     &	    AVGSTR(1,2), AVGSTR(1,3), AVGSTR(2,3)
           WRITE(11,*)DDLFT,AVGSTR(2,2)

95        FORMAT(7F10.4)
	   WRITE(12,*)DDLFT,AVGSTR(1,2)
	   WRITE(13,*)DDLFT,AVGSTR(1,1)-AVGSTR(3,3)
	...
	RETURN
	END
C((((((((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))))))   HAMAD: Checked (from line 1391 to line 1426)
...
C
	RETURN
	END
C((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))))))))) HAMAD: Checked (from line 1427 to line 1481)
	SUBROUTINE TEXTURE
	INCLUDE 'commonsn.tex'
...
c	Hamad:wp below is nothing but: [Wp_current]=[R*] [Wp_relaxed] [R*]'   where below (W*_current=wp & Wp_relaxed=wstar)
c	since Wapp=0 >> W*=-Wp
c	i.e. What we print is the following
c	[ -W*(1,2) , -W*(1,3) , -W*(2,3) ] =[ W*(2,1) , W*(3,1) , W*(3,2) ]  All in the current configuration
...
cc      write(21,12)tmp1(2,1),tmp1(3,1),tmp1(3,2) originaly used				
c	i.e. What we print is the following
c	[ -W*(1,2) , -W*(1,3) , -W*(2,3) ] =[ W*(2,1) , W*(3,1) , W*(3,2) ]  All in the current configuration

	write(21,12)tmp1(1,2),tmp1(1,3),tmp1(2,3) 

c	below for test only- sarah
!	write(111,*)((rstau(J,K,icrys),K=1,3),J=1,3)
!	write(111,12)tmp1(1,2),tmp1(1,3),tmp1(2,3) 


c12    format(9f10.6)
12    format(9f15.11,I5)
...
c200	WRITE(8,*)(180.-OM(ICRYS))*PI/180.0D0,TH(ICRYS)*PI/180.0D0,
c     &	(180.-PHI(ICRYS))*PI/180.0D0

	RETURN
	END
C((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))))))))))HAMAD: Checked (from line 1481 to 1896) 
	SUBROUTINE TRSTRESS(ICRYS)
cvd$r   noconcur
	INCLUDE 'commonsn.tex'

C	DIMENSION BALPHA(3,3,12),CALPHA(3,3,12)						HAMAD: This is for FCC and below for BCC, change 12 to 48
C	DIMENSION TMP1(3,3,12),TMP2(3,3),TMP3(3,3),TC(3,3),EC(3,3)

	DIMENSION BALPHA(3,3,12),CALPHA(3,3,12)
	DIMENSION TMP1(3,3,12),TMP2(3,3),TMP3(3,3),TC(3,3),EC(3,3)
C
...
C------------------ex sbr  FORMCMAT -------------------------------
C												
C	DO 100 I = 1,12					HAMAD: This is for FCC and below for BCC, change 12 to 48
	DO 100 I = 1,12
C
...
C
	RETURN
	END
C(((((((((((((((((((((((((((((((((((((((((()))))))))))))))))))))))))))))))))HAMAD: Checked (from line 1897 to 2218) 
...
c		LPBDT(K,M) = DGTAU(1,ICRYS)*SMATG(K,M,1,ICRYS)+
c     &                 DGTAU(2,ICRYS)*SMATG(K,M,2,ICRYS)+
c     &                 DGTAU(3,ICRYS)*SMATG(K,M,3,ICRYS)+
c     &                 DGTAU(4,ICRYS)*SMATG(K,M,4,ICRYS)+
c     &                 DGTAU(5,ICRYS)*SMATG(K,M,5,ICRYS)+
c     &                 DGTAU(6,ICRYS)*SMATG(K,M,6,ICRYS)+
c     &                 DGTAU(7,ICRYS)*SMATG(K,M,7,ICRYS)+
c     &                 DGTAU(8,ICRYS)*SMATG(K,M,8,ICRYS)+
c     &                 DGTAU(9,ICRYS)*SMATG(K,M,9,ICRYS)+
c     &                 DGTAU(10,ICRYS)*SMATG(K,M,10,ICRYS)+
c     &                 DGTAU(11,ICRYS)*SMATG(K,M,11,ICRYS)+
c     &                 DGTAU(12,ICRYS)*SMATG(K,M,12,ICRYS)+
c     &				 DGTAU(13,ICRYS)*SMATG(K,M,13,ICRYS)+
c     &                 DGTAU(14,ICRYS)*SMATG(K,M,14,ICRYS)+
c     &                 DGTAU(15,ICRYS)*SMATG(K,M,15,ICRYS)+
c     &                 DGTAU(16,ICRYS)*SMATG(K,M,16,ICRYS)+
c     &                 DGTAU(17,ICRYS)*SMATG(K,M,17,ICRYS)+
c     &                 DGTAU(18,ICRYS)*SMATG(K,M,18,ICRYS)+
c     &                 DGTAU(19,ICRYS)*SMATG(K,M,19,ICRYS)+
c     &                 DGTAU(20,ICRYS)*SMATG(K,M,20,ICRYS)+
c     &                 DGTAU(21,ICRYS)*SMATG(K,M,21,ICRYS)+
c     &                 DGTAU(22,ICRYS)*SMATG(K,M,22,ICRYS)+
c     &                 DGTAU(23,ICRYS)*SMATG(K,M,23,ICRYS)+
c     &                 DGTAU(24,ICRYS)*SMATG(K,M,24,ICRYS)+
c     &				 DGTAU(25,ICRYS)*SMATG(K,M,25,ICRYS)+
c     &                 DGTAU(26,ICRYS)*SMATG(K,M,26,ICRYS)+
c     &                 DGTAU(27,ICRYS)*SMATG(K,M,27,ICRYS)+
c     &                 DGTAU(28,ICRYS)*SMATG(K,M,28,ICRYS)+
c     &                 DGTAU(29,ICRYS)*SMATG(K,M,29,ICRYS)+
c     &                 DGTAU(30,ICRYS)*SMATG(K,M,30,ICRYS)+
c     &                 DGTAU(31,ICRYS)*SMATG(K,M,31,ICRYS)+
c     &                 DGTAU(32,ICRYS)*SMATG(K,M,32,ICRYS)+
c     &                 DGTAU(33,ICRYS)*SMATG(K,M,33,ICRYS)+
c     &                 DGTAU(34,ICRYS)*SMATG(K,M,34,ICRYS)+
c     &                 DGTAU(35,ICRYS)*SMATG(K,M,35,ICRYS)+
c     &                 DGTAU(36,ICRYS)*SMATG(K,M,36,ICRYS)+
c     &				 DGTAU(37,ICRYS)*SMATG(K,M,37,ICRYS)+
c     &                 DGTAU(38,ICRYS)*SMATG(K,M,38,ICRYS)+
c     &                 DGTAU(39,ICRYS)*SMATG(K,M,39,ICRYS)+
c     &                 DGTAU(40,ICRYS)*SMATG(K,M,40,ICRYS)+
c     &                 DGTAU(41,ICRYS)*SMATG(K,M,41,ICRYS)+
c     &                 DGTAU(42,ICRYS)*SMATG(K,M,42,ICRYS)+
c     &                 DGTAU(43,ICRYS)*SMATG(K,M,43,ICRYS)+
c     &                 DGTAU(44,ICRYS)*SMATG(K,M,44,ICRYS)+
c     &                 DGTAU(45,ICRYS)*SMATG(K,M,45,ICRYS)+
c     &                 DGTAU(46,ICRYS)*SMATG(K,M,46,ICRYS)+
c     &                 DGTAU(47,ICRYS)*SMATG(K,M,47,ICRYS)+
c     &                 DGTAU(48,ICRYS)*SMATG(K,M,48,ICRYS)


 10   TMP1(K,M)  = ONET(K,M)-LPBDT(K,M)

c	Hamad: below is [Wp_relaxed] =0.5*(Lp_relaxed-Lp_relaxed'] 
c	The name is confusing
      wstar(1,icrys)=wstar(1,icrys)+0.5*(lpbdt(1,2)-lpbdt(2,1))!Wp_relaxed(1,2)
      wstar(2,icrys)=wstar(2,icrys)+0.5*(lpbdt(1,3)-lpbdt(3,1))!Wp_relaxed(1,3)
      wstar(3,icrys)=wstar(3,icrys)+0.5*(lpbdt(2,3)-lpbdt(3,2))!Wp_relaxed(2,3)
      
c	wstar(1,icrys)=0.5*(lpbdt(1,2)-lpbdt(2,1))
c      wstar(2,icrys)=0.5*(lpbdt(1,3)-lpbdt(3,1))
c      wstar(3,icrys)=0.5*(lpbdt(2,3)-lpbdt(3,2))
...
C        DO 35 I=1,12								HAMAD: This is for FCC and below for BCC, change 12 to 48
	  DO 35 I=1,12
