...
set_id_cal = 'cal004'  # set ID for calibration dataset
dir_cal = 'cal004'  # directory name for .dat files
...
set_id_val = 'val004'  # set ID for validation dataset
dir_val = 'val004'  # directory name for .dat files
