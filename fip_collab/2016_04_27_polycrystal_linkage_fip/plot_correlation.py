...
def pltcorr(el, vmax, ns, set_id, step, sn, iA, iB):
    ...
    plt.subplot(122)
    midslc = np.int64(np.floor(vmax/2.))
    ax = plt.imshow(corr_centered[midslc, :, :], origin='lower',
...
if __name__ == '__main__':
    ...
    pltcorr(vmax, ns, set_id, step, sn, iA, iB)
