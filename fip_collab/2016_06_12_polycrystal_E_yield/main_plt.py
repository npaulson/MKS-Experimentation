...
pltpcpoly.pltpcpoly('modulus', 5)
pltpcpoly.pltpcpoly('strength', 6)

"""Plot the predicted versus actual values of the property of interest"""
n_poly = 2
plc.plot_check(ns_val, names_val, 'modulus', n_poly, 7)
plc.plot_check(ns_val, names_val, 'strength', n_poly, 8)
plt.show()
