...
def new_space(ns_set, sid_set):
    ...
    for ii in xrange(len(sid_set)):
        ...
        tmp = f_stats.get('ff_%s' % sid_set[ii])[...]
    ...
    pca = IncrementalPCA(C['n_pc_tot'], batch_size=100)
...
if __name__ == '__main__':
    ns_set = [10, 10, 10]
    sid_set = ['random', 'transverse', 'basaltrans']

    reduce(ns_set, sid_set)
