...
def resp(ns, set_id):
    ...
    # c0 = f2.create_dataset('c0_%s' % set_id, (1,), dtype='float64')
    # c1 = f2.create_dataset('c1_%s' % set_id, (1,), dtype='float64')
    # c2 = f2.create_dataset('c2_%s' % set_id, (1,), dtype='float64')
    ...
    f2.create_dataset('c0_%s' % set_id, data=gamma_stats[0])
    f2.create_dataset('c1_%s' % set_id, data=gamma_stats[1])
    f2.create_dataset('c2_%s' % set_id, data=gamma_stats[2])
