...
# 
index_final := ImportMatrix(index_final_txt); tfunction_final := ImportMatrix(tfunction_final_txt); start_l := index_final[1, 1]; end_l := index_final[-1, 1];
...
dir := currentdir();
file := cat(dir, "/gsh_cub_tri_L", start_l, "_", end_l, ".py");
