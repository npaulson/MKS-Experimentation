...
filename = 'Results_Ti64_RandomMicroFZreducedNewBCs_21x21x21_AbqInp_AnisoLE_00001_data_stress_max_C2.txt'
max_el = file_read(filename,3)

filename = 'Results_Ti64_RandomMicroFZreducedNewBCs_21x21x21_AbqInp_PowerLaw_00001_data_stress_max_C2.txt'
...
plt.title('Linear Elastic, $\sigma_{33}$ (MPa)')
...
msg = 'Mean Sigma33 from LE: %s' %avg_LE
rr.WP(msg,wrt_file)
msg = 'Minimum Sigma33 from LE: %s' % np.min(max_el)
rr.WP(msg,wrt_file)
msg = 'Maximum Sigma33 from LE: %s' % np.max(max_el)
rr.WP(msg,wrt_file)

msg = 'Mean Sigma33 from CPFEM: %s' %avg_CPFEM
rr.WP(msg,wrt_file)
msg = 'Minimum Sigma33 from CPFEM: %s' % np.min(max_pl)
rr.WP(msg,wrt_file)
msg = 'Maximum Sigma33 from CPFEM: %s' % np.max(max_pl)
rr.WP(msg,wrt_file)
