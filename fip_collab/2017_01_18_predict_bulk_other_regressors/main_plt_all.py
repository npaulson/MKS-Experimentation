...
pcB = 1
pcC = 2
pltmap_cal.pltmap(6, pcA, pcB)
pltmap_val.pltmap(6, pcA, pcB)
pltmap3d.pltmap(6, pcA, pcB, pcC)

"""Plot a dendrogram"""
pd.pltdend(ns_cal, set_id_cal, names_cal, 6)

"""Plot the errors versus number of PCs and polynomial order"""
pevp.plterr('modulus', C['n_pc_max'], 0.6, 'cal', Hvec)
pevp.plterr('modulus', C['n_pc_max'], 0.6, 'cv', Hvec)
pevp.plterr('modulus', C['n_pc_max'], 0.6, 'val', Hvec)
# pevp.plterr('strength', C['n_pc_max'], 4, 'cal', Hvec)
# pevp.plterr('strength', C['n_pc_max'], 4, 'cv', Hvec)
# pevp.plterr('strength', C['n_pc_max'], 4, 'val', Hvec)

"""Plot the predicted versus actual values of the property of interest"""
plc.plot_check('modulus', n_pc=5, n_poly=2, H=6)
# plc.plot_check('strength', n_pc=2, n_poly=2, H=6)
