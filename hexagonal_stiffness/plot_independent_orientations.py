...
phi2vec = np.linspace(0,np.pi/3,2*base)
...
sio.savemat('orientation',{'unique_list1':unique_list1,'unique_list2':unique_list2,'phi1vec':phi1vec,'Phivec':Phivec,'phi2vec':phi2vec,'eulervec':eulervec})
